...
class Shift4Provider implements PaymentProviderInterface
{
    ...
    /**
     * Processes a payment using Shift4.
     *
    ...
    {
        // Generate a token for the payment using the card details
        $getToken = $this->processGetTokens($params);

        // Validate required parameters for payment processing
        ...
        try {
            // Make the API request to Shift4 to process the payment
            ...
            // Return a formatted response with the payment details
     ...
     */
    private function processGetTokens(array $params): array
    {
        ...
        // Make the API request to retrieve a token
